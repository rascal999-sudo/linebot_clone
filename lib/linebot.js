...
class LineBot extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.options.channelId = options.channelId || '1655614728';
    this.options.channelSecret = options.channelSecret || 'f53f33fc998f32375a3ba7fb9f24fd48';
    this.options.channelAccessToken = options.channelAccessToken || 'r5iTmDLe9WOD6fn6C8qkjGxhc0JW/YtmKYNf+7bgTBG+AQqsTV7GCx9t1EyYslZwU1Bm1jSSGxOHHI5aM57XcGX2mMFgGKR3HL+aSOWIn1aTpiOhdRB/BVdzMcTydAc9G13430UAft4U21lBflUX2gdB04t89/1O/w1cDnyilFU=';
